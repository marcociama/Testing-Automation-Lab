public class TennisScoreManager {
    ...
    public TennisScoreManager() {
        // Inizializza gli array dei set a zero per pulizia, anche se non strettamente necessario in Java
        for (int i = 0; i < 5; i++) {
            setsP1[i] = 0;
            setsP2[i] = 0;
        }
   ...
   public String getTieBreakScore() {
    ...
    public void checkSetPoint() {
        ...
        if (gamesP1 >= 6 && gamesP1 >= gamesP2 + 2 || (gamesP1 == 7 && gamesP2 == 5) || (gamesP2 == 7 && gamesP2 == 6)) {
        ...
        } else if (gamesP2 >= 6 && gamesP2 >= gamesP1 + 2 || (gamesP2 == 7 && gamesP1 == 5) || (gamesP2 == 7 && gamesP1 == 6)) {
    ...
    public String getMatchScore() {
        ...
        if (!isGameOver()) {
            return setsWonP1 + "-" + setsWonP2 + " (Game: " + gamesP1 + "-" + gamesP2 + " " + (isTieBreak ? getTieBreakScore() : getGameScore()) + ")";
        }
    ...
    public boolean isGameOver() {
        ...
        for (int i = 0; i < currentSet; i++) {
            if (setsP1[i] > setsP2[i]) setsWonP1++;
            if (setsP2[i] > setsP1[i]) setsWonP2++;
        }
